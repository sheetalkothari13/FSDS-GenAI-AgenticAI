...
model = pickle.load(open(r'C:\Users\Sheetal\SheetalProjects\August\19th- SLR Fullstack Salary Prediction\linear_regression_model.pkl', 'rb'))
...
st.write("The model was trained using a dataset of salaries and years of experience. Built by Sheetal")